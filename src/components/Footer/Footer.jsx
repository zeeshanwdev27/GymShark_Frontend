...
function Footer() {
  return (
    <>
      <div className=" py-10 px-14 w-full border-t border-gray-200 shadow-sm ">
        <div className="grid grid-cols-2 gap-58">
        ...
        <div className="flex justify-center items-center gap-2">
          <img className="w-10" src="https://images.ctfassets.net/wl6q2in9o7k3/5PrfyA9tb7E5sX4VJOvUXU/5c7d1da15bcb3ea9bc846698b14da4c0/visa-card.svg" alt="visa_card" />
          <img className="w-10" src="https://images.ctfassets.net/wl6q2in9o7k3/LwfpWwq8TXIansB91xPmD/d20403df94193ad356b8ea0a2df4e9f1/mastercard-card.svg" alt="mastercard" />
          <img className="w-10" src="https://images.ctfassets.net/wl6q2in9o7k3/7shmU9DfzLDbUk4b6obKoX/d3dd37478163f60363dc9c982b6fd56e/amex-card.svg" alt="americanexpress" />
          <img className="w-10" src="https://images.ctfassets.net/wl6q2in9o7k3/30jtAlNtcunM6pu0L8Xar/f528a13df611d9585b73a36fe35b8797/paypal-card.svg" alt="paypal" />
          <img className="w-10" src="https://images.ctfassets.net/wl6q2in9o7k3/5AUy4FwF2qwCL5Xog760Xf/1839c30ce2dbe6b7119f4dab3f15920b/applepay-card.svg" alt="applepay" />
        ...
        <a href="https://instagram.com" target="_blank" rel="noopener noreferrer">
          ...
          <FaTiktok className="w-5 h-5 hover:text-[#FE2C55] transition-colors" />
        </a>
        <a href="https://twitter.com" target="_blank" rel="noopener noreferrer">
          <FaXTwitter className="w-6 h-6 hover:text-sky-500 transition-colors" />
        </a>
        ...
        <a href="https://twitch.tv" target="_blank" rel="noopener noreferrer">
          <FaPinterest  className="w-6 h-6 hover:text-red-500 transition-colors" />
        </a>
        </div>
      ...
      <div className="flex justify-between py-5 px-14 w-full ">
